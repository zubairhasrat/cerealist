      ...
      <div className="flex items-center gap-[6px] md:gap-[9.5px]">
        {socialLinks.map(({ platform, icon }) => (
          <a
            ...
            className="block transition-transform drop-shadow-[0px_4px_0px_rgba(0,0,0,0.85)] md:drop-shadow-[0px_5px_0px_rgba(0,0,0,0.85)] active:translate-y-1 active:drop-shadow-[0px_2px_0px_rgba(0,0,0,0.85)]"
          >
            <Image
              src={icon}
              alt={platform}
