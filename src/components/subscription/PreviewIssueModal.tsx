    ...
    >
      ...
      >
        ...
        <div className="relative z-10 pt-8 pb-7 px-6 flex flex-col items-center">
          ...
          <button
            onClick={handleCTA}
            className="relative mt-4 w-full h-[50px] overflow-hidden rounded-[8px] border-[2.3px] border-[#606060] shadow-[0px_5px_3px_0px_black,0px_6px_9px_0px_rgba(0,0,0,0.25)] active:shadow-none active:translate-y-[4px] transition-all"
          >
