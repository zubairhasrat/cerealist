      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-5 lg:items-stretch">
        ...
        >
          ...
          <div className="hidden lg:flex absolute top-0 left-0 right-0 h-[58px] items-center justify-center z-20 overflow-hidden">
            <div className="absolute inset-0 bg-[url('/images/btn-light-beige-bg.png')] bg-cover bg-center opacity-80" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#b8895a] via-[#d4a96a] to-[#b8895a] opacity-70" />
            <span className="relative z-10 text-[22px] font-semibold text-white tracking-[0.1em] drop-shadow-[0px_1px_2px_rgba(0,0,0,0.5)]">
              MOST POPULAR
            </span>
          </div>
            ...
            <div className="flex justify-center">
              <div className="flex flex-col items-start gap-1.5">
                <div className="flex items-center gap-2">
                  <CheckIcon />
                  <span className="text-[17px] phone:text-[19px] lg:text-[21px] font-normal text-ink-mid">Includes every new release</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckIcon />
                  <span className="text-[17px] phone:text-[19px] lg:text-[21px] font-normal text-ink-mid">Pause or cancel anytime</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div
          className="relative border-[1.5px] border-black rounded-[11.984px] overflow-hidden cursor-pointer lg:flex-1"
        ...
        >
          ...
          <div className="relative z-10 px-5 py-5 lg:py-8 text-center flex flex-col items-center">
            ...
            <div className="flex items-center justify-center gap-2">
              <CheckIcon />
              <span className="text-[17px] phone:text-[19px] lg:text-[21px] font-normal text-ink-mid">A one-time purchase</span>
            </div>
          </div>
        </div>
      </div>
