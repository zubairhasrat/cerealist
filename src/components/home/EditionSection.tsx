...
// Mobile/tablet (<lg): POLITICS | SPORTS / OPINION | THE FUNNIES
// Left-col (1st, 3rd): no mobile px, no mobile py
// Right-col (2nd, 4th): pl-2 on mobile, no mobile py
const ARTICLES: ArticleCardProps[] = [
  {
    ...
    mobileBorderClass: "border-b border-r border-ink lg:border-b-0 lg:border-r-0",
    mobilePadClass: "pb-2 lg:pb-0",
  },
  {
    category: "SPORTS",
    ...
    mobileBorderClass: "border-b border-ink lg:border-b-0 lg:border-l",
    mobilePadClass: "pl-2 pb-2 lg:pb-0",
  },
  {
    ...
    // right-col, bottom-row: left padding
    mobilePadClass: "pl-2 pt-2 lg:pt-0",
  },
  {
    ...
    // left-col, bottom-row: right border only
    mobileBorderClass: "border-r border-ink pt-2 lg:border-r-0 lg:pt-0",
  },
];
    ...
    <section className="bg-transparent mt-8">
      <ContentContainer>
        ...
        <div className="px-0 lg:px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 lg:divide-x lg:divide-ink lg:border-l lg:border-ink mt-6">
