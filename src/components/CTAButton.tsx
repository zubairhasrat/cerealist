...
export default function CTAButton({
  ...
  const variants = {
    ...
    "hero-dark":
      "text-cream-light border-ink rounded-[10px] shadow-[1px_3px_0px_0px_#000] active:shadow-none active:translate-x-[2px] active:translate-y-[2px] overflow-hidden",
    "hero-light":
      "text-ink border-ink rounded-[10px] shadow-[1px_3px_0px_0px_#000] active:shadow-none active:translate-x-[2px] active:translate-y-[2px] overflow-hidden",
  };
