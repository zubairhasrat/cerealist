  ...
  return (
    <section className="bg-transparent">
      <ContentContainer className="xl:px-12">
        <div className="grid md:grid-cols-[1fr_280px] lg:grid-cols-[1fr_420px] xl:grid-cols-[1fr_596px] gap-6 xl:gap-8 py-8 md:py-12">

          {/* ── Left column ─────────────────────────────────────── */}
          <div>
            {/* Headline */}
            <h1 className="font-[family-name:var(--font-crimson)] font-semibold text-[42px] max-2xs:text-[40px] md:text-[52px] lg:text-[65px] xl:text-[79px] leading-none tracking-[-0.02em] text-ink text-center md:text-left">
              The Morning Paper, Now on Cereal.
            </h1>

            {/* Italic subtitle */}
            <p className="font-[family-name:var(--font-crimson)] italic text-[27px] md:text-[26px] lg:text-[33px] xl:text-[40px] md:leading-[1.15] xl:leading-[42px] text-ink-warm mt-4 text-center md:text-left">
              A monthly cereal for people who grew up, but never stopped liking cereal.
            </p>

            {/* Hairline rule */}
            <hr className="border-ink border mt-3 mb-[2px]" />
            <hr className="border-ink border mb-4" />

            {/* Body text */}
            <div className="font-[family-name:var(--font-crimson)] text-[20px] md:text-[22px] lg:text-[28px] xl:text-[35px] text-ink-mid leading-[28px] md:leading-[30px] lg:leading-[36px] xl:leading-[43px]">
              {/* Mobile: image floats left within body text */}
              <div className="md:hidden float-left mr-3 sm:mb-2 w-[38%]">
                <Image
              ...
              <span
                aria-hidden="true"
                className="hidden md:inline-block float-left font-[family-name:var(--font-crimson)] font-semibold text-[70px] lg:text-[90px] xl:text-[105px] leading-[0.8] tracking-[-0.02em] text-ink mr-1"
              >
                P
              </span>
